...
import ProduksiJakarta from './produksiJakarta'
import InflasiJakarta from './inflasiJakarta'
import KonsumsiJakarta from './konsumsiJakarta'
...
function Jakarta(){
          ...
          <div className='container'>
            <div className='row'>
              <div className='col-md-8 col-md-offset-2 beras-text'>
                <h1>Provinsi DKI Jakarta
                  <span></span>
                </h1>
                <p>Peramalan Harga Beras, Produksi Padi, Tingkat Inflasi, Konsumsi Provinsi DKI Jakarta Periode Januari-Desember 2022</p>
                <a
                  href='#features'
    ...
    <div id='features' className='text-center'>
      <div className='container'>
        <div className='col-md-10 col-md-offset-1 section-title'>
          <h2>Peramalan Harga Beras Provinsi DKI Jakarta</h2>
          <p>Plot Peramalan Harga Beras Provinsi DKI Jakarta Periode Januari 2021 - Desember 2022</p>
        </div>
    ...
    <h3>Berikut tabel hasil peramalan harga beras di provinsi DKI Jakarta</h3>
