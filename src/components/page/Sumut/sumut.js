...
import ProduksiSumut from './produksiSumut'
import InflasiSumut from './inflasiSumut'
import KonsumsiSumut from './konsumsiSumut'
function SumateraUtara(){
    ...
    <div id='features' className='text-center'>
      <div className='container'>
        <div className='col-md-10 col-md-offset-1 section-title'>
          <h2>Peramalan Harga Beras Provinsi Sumatera Utara</h2>
          <p>Plot Peramalan Harga Beras Provinsi Sumatera Utara Periode Januari 2021 - Desember 2022</p>
        </div>
    ...
    <h3>Berikut tabel hasil peramalan harga beras di provinsi Sumatera Utara</h3>
    <h4>Model : Y = 8717.7 - 0.0276X1 + 102.37X 2 + 0.0446X3 + 148</h4>    
