...
function KonsumsiJogja(){
    const styles={marginLeft:"20%"}
    return(
        <div id="produksi">
        <div className='container'>
        <div className='col-md-10 col-md-offset-1 section-title'>
          <h2>Peramalan Jumlah Pengeluaran Konsumsi Beras Provinsi Yogyakarta</h2>
          <p>Plot Peramalan Jumlah Pengeluaran Konsumsi Beras Provinsi Yogyakarta Periode Januari 2021 - Desember 2022</p>
        </div>
        ...
        <Line 
            ...
            <h3>Berikut tabel hasil peramalan jumlah pengeluaran konsumsi beras di provinsi Yogyakarta</h3>
